...
app.use(cors({
  origin: [
    'http://16.171.145.31:8078', // Login Server
    'http://16.171.145.31:3043', // Employee Server
    'http://16.171.145.31:5500', // Live Server (Default)
    'http://127.0.0.1:5500', // Live Server (IP)
   // 'http://16.171.145.31:8079'  // Live Server (Alternate)
  ]
}));
